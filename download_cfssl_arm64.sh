...
#
# wget -c "https://github.com/cloudflare/cfssl/releases/download/1.2.0/cfssl-certinfo_linux-arm64" -O cfssl-certinfo_linux-arm64
# wget -c "https://github.com/cloudflare/cfssl/releases/download/1.2.0/cfssl_linux-arm64"          -O cfssl_linux-arm64
# wget -c "https://github.com/cloudflare/cfssl/releases/download/1.2.0/cfssljson_linux-arm64"      -O cfssljson_linux-arm64
...
#
# wget -c "http://199.115.230.237:12345/kubernetes/cfssl-certinfo_linux-arm64" -O cfssl-certinfo_linux-arm64
# wget -c "http://199.115.230.237:12345/kubernetes/cfssl_linux-arm64"          -O cfssl_linux-arm64
# wget -c "http://199.115.230.237:12345/kubernetes/cfssljson_linux-arm64"      -O cfssljson_linux-arm64
