...
# wget -c "https://download.docker.com/linux/static/stable/x86_64/docker-24.0.9.tgz" -O docker_x86_64/docker-24.0.9.tgz
...
tar xzf docker_x86_64/docker-24.0.9.tgz
